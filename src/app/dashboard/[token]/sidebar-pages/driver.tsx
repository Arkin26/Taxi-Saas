...
// type ImageFieldType = 'aadharImage' | 'licenseImage' | 'profilePhoto';
...
//   const [imagePreviews, setImagePreviews] = useState<Record<ImageFieldType, string | null>>({
//     aadharImage: null,
//     licenseImage: null,
//     profilePhoto: null,
//   });
...
//             <img
//               src={imagePreviews[imageType] as string}
//               alt={label}
...
//                 Click to upload
//               </button>
//               <p className="text-xs mt-1 text-gray-500">PNG, JPG up to 5MB</p>
//             </div>
//           </div>
//         )}
//         <input
...
//       <h1 className="text-3xl font-bold text-gray-900 mb-8">Add Driver Details</h1>
...
//           <div className="space-y-6">
//             <h2 className="text-xl font-semibold text-gray-800 border-b pb-2">Document Information</h2>
...
//         {/* Image Uploads */}
//         <div className="mt-8">
//           <h2 className="text-xl font-semibold text-gray-800 border-b pb-2 mb-6">Document & Photo Uploads</h2>
//           <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
//             <ImageUploadField label="Profile Photo" imageType="profilePhoto" icon={Camera} />
//             <ImageUploadField label="Aadhar Card Image" imageType="aadharImage" icon={FileText} />
//             <ImageUploadField label="License Image" imageType="licenseImage" icon={CreditCard} />
//           </div>
//         </div>
